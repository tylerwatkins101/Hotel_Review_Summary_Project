...
def rating_reviews(hotel):
    ...
    """Returns the total number of reviews and mean review rating out of 5."""
...
def generate_wordcloud(hotel):
    ...
    """Returns a wordcloud showing the most frequently used words used by reviewers."""
...
def get_sentiment(hotel):
    ...
    """Returns a graphical overview of the negative, neutral and positive sentiment of reviewers."""

    # Make review text into a single doc
    doc_complete = list(hotel.cleanrev)

    # Use NLTK built in sentiment analysis function
    import nltk
...
def get_topics(hotel):
    ...
    """Returns a list of the 10 most important words in each of the 3 main topics reviewers focused on."""
