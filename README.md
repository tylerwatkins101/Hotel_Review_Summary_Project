...
The following packages are used for this project and may need to be installed prior to running the tool. The recommended method of installation is to use pip install from the command line. For example, in the command line type: pip install numpy, to install the numpy requirement in case you don't already have it.
